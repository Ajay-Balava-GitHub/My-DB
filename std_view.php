            ...
            <div>
              <div class="collapse navbar-collapse" id="myNavbar">
                <ul class="nav navbar-nav navbar-right">
				  ...
				  <li class="active"><a href="std_view.php">View Student</a></li>
		 ...
		 <hr/>
			...
			<thead>
				...
				<tr>
					...
					<td><a href="std_update.php?id=<?php echo $row['eno'];?>" >Edit</a></td>
					<td><a href="std_delete.php?id=<?php echo $row['eno'];?>" >X</a></td>
				</tr>
				</tbody>
				<?php
					}
