                ...
                <ul class="nav navbar-nav navbar-right">
                  ...
                  <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Members <span class="caret"></span></a>
                    <ul class="dropdown-menu">
					  ...
					  <li class="active"><a href="staff_reg.php">Staff Registration</a></li>
        ...
        <div class="container">
             ...
             <div class="row">
                   <div class="col-lg-6 col-offset-6 centered" id="MyFormColumn">
                        <center><h2><i class="fa fa-briefcase"></i> Staff Registration </h2></center><hr />
                        ...
                        <div class="form-group">
                             ...
                             <div class="input-group">
                                  ...
                                  <input type="text" name="f_name" placeholder="Enter Name Here.." maxlength="20" class="form-control" required/>
                             </div>
                        </div>
                        <div class="form-group">
